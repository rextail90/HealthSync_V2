...
class CompletedExercisesPage extends StatelessWidget {
  ...
  const CompletedExercisesPage(
      {super.key, required this.duration, required this.completedExercises});
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Provider.of<ExerciseHistoryProvider>(context, listen: false)
                .addCompletedSession(duration, completedExercises);
      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Great Job Finishing Your Exercise!',
          ...
          const Text('Here are your stats:',
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Text(
                      'Sets: ${completedExercises[index]['sets']}, Reps: ${completedExercises[index]['reps']}'),
                );
              },
            ),
          ),
